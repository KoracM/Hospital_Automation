...
public class hasta_giris_ekran_islemleri {

    //component degiskenler
    private JTextField jTextField_TCKN;
    
    private JPasswordField jPasswordField;

    private String girilenTCKN;
    ...
    */
    //constructor
    public hasta_giris_ekran_islemleri(JTextField jTextField_TCKN, JPasswordField jPasswordField) {
        this.jTextField_TCKN = jTextField_TCKN;
        this.jPasswordField = jPasswordField;

        this.girilenTCKN = jTextField_TCKN.getText();
    ...
    */
    ...
    public boolean bosGirisKontrol() {
        ...
        if (girilenTCKN.equals("") & girilenSifre.equals("")) {
            this.sonucMesaj = "TCKN ve Sifre giriniz!";
            return false;
        } else if (girilenTCKN.equals("")) {
            this.sonucMesaj = "TCKN giriniz!";
            return false;
